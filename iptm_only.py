...
class Prediction_folder:
    ...
    def write_out_contacts(self):
        """Write out the atom-atom contacts found in predicted models."""
        contacts_out_path = os.path.join(self.path_to_prediction_folder, 'atom_atom_contacts.tsv')

        # Sample code to write out contacts data to a file
        with open(contacts_out_path, 'w') as f:
            f.write("Example contacts data\n")
